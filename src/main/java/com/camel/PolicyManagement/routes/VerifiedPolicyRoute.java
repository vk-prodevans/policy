...
public class VerifiedPolicyRoute extends RouteBuilder {
     @Override
    public void configure() throws Exception {
        ...
        from("rest:get:getVerifiedPolicies")
                .routeId("getVerifiedPolicies")
                .setHeader("Access-Control-Allow-Credentials", constant("true"))
                .log("getPolicies route started at: ${date:now:yyyy-MM-dd HH:mm:ss}")
                .doTry()
                .setBody(simple("SELECT i.insurance_id, i.insurance_plan, a.application_status, c.user_id, c.customer_username " +
